...
if option == "1":
    ...
    print("in infrared light, allowing it to see through dust clouds")
    print("and study distant galaxies.")
    print("It is the most powerful space telescope ever built") 
    print("and has provided unprecedented insights into the early")
    print("universe, star formation, and exoplanets.")
    print("A joint project of NASA, ESA, and CSA.")
    ...
    print("description: A space telescope that orbits Earth and")
    print("provides high-resolution images of space,")
    print("providing insights into the universe's structure and")
    print("evolution.")
    print("It has made numerous significant discoveries,")
    print("including determining the rate of expansion of the universe")
    print("and identifying exoplanets.")
    print("Was built by NASA and ESA.")
