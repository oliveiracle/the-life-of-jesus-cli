...
if "NASA" in space_agencies:
    print(f"✅ NASA está na lista com orçamento de ${agency_budget['NASA']:,} USD")

if "ESA" in space_agencies:
    print(f"✅ ESA está na lista com orçamento de ${agency_budget['ESA']:,} USD")

if "Roscosmos" in space_agencies:
    print("✅ Roscosmos está na lista!")
    print("🌍 Russia tem uma rica história na exploração espacial!")
    print("👨‍🚀 Eles lançaram o primeiro humano, Yuri Gagarin, ao espaço em 1961.")
