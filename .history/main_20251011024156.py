...
# ==============================================================================
# 4. EXEMPLOS DE OPERADORES PYTHON (in e not in)
# ==============================================================================

print("\n" + "="*60)
print("🔍 DEMONSTRAÇÃO DOS OPERADORES 'in' e 'not in'")
print("="*60)

# Exemplo 1: Operador 'in' - Verificando agências espaciais
print("📌 EXEMPLO 1: Operador 'in' - Agências Espaciais")
space_agencies = ["NASA", "ESA", "CSA", "Roscosmos"]
agency_budget = {
    "NASA": 25_000_000_000,
    "ESA": 7_000_000_000,
    "CSA": 500_000_000,
    "Roscosmos": 3_000_000_000
}

if "NASA" in space_agencies:
    nasa_budget = agency_budget['NASA']
    print(f"✅ NASA está na lista com orçamento de ${nasa_budget:,} USD")

if "ESA" in space_agencies:
    esa_budget = agency_budget['ESA']
    print(f"✅ ESA está na lista com orçamento de ${esa_budget:,} USD")

if "Roscosmos" in space_agencies:
    print("✅ Roscosmos está na lista!")
    print("🌍 Russia tem uma rica história na exploração espacial!")
    print("👨‍🚀 Eles lançaram o primeiro humano, Yuri Gagarin, "
          "ao espaço em 1961.")

print("\n📌 EXEMPLO 2: Operador 'not in' - Planetas sem missões")
# Exemplo 2: Operador 'not in' - Verificando planetas sem missões
current_missions = [
...
if "Venus" not in current_missions:
    print("❌ Não temos missões atuais para Vênus.")

if "Mercury" not in current_missions:
    print("❌ Não temos missões atuais para Mercúrio.")

if "Uranus" not in current_missions:
    print("❌ Não temos missões atuais para Urano.")

# Exemplo 3: Verificando se existe missão para Marte
if "Mars" not in current_missions:
    print("❌ Não temos missões para Marte.")
else:
    print("✅ Temos missões ativas para Marte!")

print("\n📌 EXEMPLO 3: Operador 'in' - Categorias de missões")
# Exemplo 3: Categorização de missões usando 'in'
telescope_missions = ["James Webb", "Hubble", "Spitzer", "Chandra", "Kepler"]
rover_missions = ["Perseverance", "Curiosity"]

example_mission = "Hubble"
if example_mission in telescope_missions:
    print(f"🔭 {example_mission} é uma missão de TELESCÓPIO!")

example_mission = "Perseverance"
if example_mission in rover_missions:
    print(f"🚗 {example_mission} é uma missão de ROVER!")

print(f"\n🎓 Operadores estudados: 'in' e 'not in'")
print("✨ Esses operadores são úteis para verificar se um item está (ou não) em uma lista!")
