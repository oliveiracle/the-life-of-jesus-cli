...
# Show title and mission options
missions.show_title()
...
if "NASA" in space_agencies:
    ...
    print("🚀 The company is revolutionizing space travel with reusable rockets!")  
...
elif "Mars" not in current_missions:
    print("❌ No current missions to Mars.")
elif "Jupiter" not in current_missions:
    print("❌ No current missions to Jupiter.")    
elif "Saturn" not in current_missions:
    print("❌ No current missions to Saturn.")
else:
    print("✅ Current missions are exploring a variety of exciting destinations in our solar system and beyond!")
