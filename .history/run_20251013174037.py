...
# MOMENT 1 - ANGEL'S ANNOUNCEMENT
if option == "1":
    # ANGEL'S ANNOUNCEMENT DETAILS
    moment_name = "The Angel Gabriel Announces Jesus' Birth to Mary"
    moment_type = "divine announcement"
    moment_type_formatted = moment_type.capitalize()  # "Divine Announcement"
    location = "Nazareth"
    participants = "Angel Gabriel and Mary"
    main_verse = "Luke 1:30-31"
    significance = ("This moment marks the divine announcement of Jesus' birth, "
                    "fulfilling Old Testament prophecies and God's plan for salvation.")
    time_period = "Circa 4-6 BC"
