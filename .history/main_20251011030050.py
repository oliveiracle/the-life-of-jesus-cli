...
if option == "1":
    ...
    current_situation = "actively exploring and sending data back to Earth"
    #operator 'in' - verificar instrumentos
    curiosity_instruments = ["ChemCam", "MAHLI", "APXS", "SAM"]
    if "SAM" in curiosity_instruments:
        print("🔬 Curiosity has the SAM instrument for analyzing organic compounds!")
    elif "MOXIE" in curiosity_instruments:
        print("🔬 Curiosity has the MOXIE instrument for producing oxygen!")
    elif "APXS" not in curiosity_instruments:
        print("🔬 Curiosity does not have the APXS instrument for producing oxygen.")
    else:
        print("🔬 Curiosity has a unique set of scientific instruments!")
