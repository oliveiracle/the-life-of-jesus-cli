...
if option == "1":
    ...
    print("description: A rover designed to explore the surface of Mars")
    print("and search for signs of past life.")
    print("It is equipped with advanced scientific instruments")
    print("to analyze soil and rock samples.")
