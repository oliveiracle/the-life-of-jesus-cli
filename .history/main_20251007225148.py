...
if option == "1":
    ...
    print(f"📏 Size: {size}")
    curiosity_statement = ("The Delta IV Heavy is larger and more powerful "
                           "than the Falcon Heavy, but smaller than the SLS.")
    print(curiosity_statement)
    ...
    size = "322 feet tall"
    curiosity = bigger_than_falcon_heavy = True
    ...
    print(f"💪 Thrust: {horsepower:,} pounds")
    print(f"📏 Size: {size}")
    curiosity_statement = ("The SLS is larger and more powerful than "
                           "the Falcon Heavy.")
