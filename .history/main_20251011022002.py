...
if "Mars" not in current_missions:
    print("✅ Active missions exploring Mars.")
    print("🔴 Perseverance and Curiosity rovers are currently on Mars.")
    print("🚀 SpaceX Starship aims to take humans to Mars in the future.")
