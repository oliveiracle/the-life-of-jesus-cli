...
# ← ADICIONE TUDO ABAIXO DESTA LINHA ↓
...
telescope_missions = ["James Webb", "Hubble", "Spitzer", "Chandra", "Kepler", "TESS"]
rover_missions = ["Perseverance", "Curiosity"]
spacecraft_missions = ["Voyager 1", "New Horizons", "Galileo", "Juno", "OSIRIS-REx"]
rocket_missions = ["SpaceX Starship", "Ariane 5", "Soyuz", "Falcon 9", "Atlas V", "Delta IV", "SLS"]
...
planets_targets = ["Mars", "Jupiter", "Saturn", "Earth", "Moon", "Asteroid", "Pluto"]
...
valid_options = "123456789101112131415161718192021222324​25"
user_example = "7"
...
print("\n🌟 Containment operators help us search through God's universe data efficiently!")

# Truthy/Falsy Exercise - Code Institute requirement  
a = []          # Empty list = False
b = ""          # Empty string = False  
c = "hello"     # String with content = True
d = 0.0         # Float zero = False
e = 5           # Non-zero integer = True
