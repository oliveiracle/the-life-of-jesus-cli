...
# MOMENT 12 - RAISING LAZARUS
   ...
   print(f"🍷 {moment_type}: {jesus_moments.moment12_formatted}")
    ...
    print()
    print("🙏 May we believe in Jesus as the resurrection and the life, trusting in His power over death!")
...
# MOMENT 15 - PRODIGAL SON
    ...
    pharisees_reaction = ("The Pharisees and the teachers of the law "
                         "mutually grumbled, 'This man  welcomes sinners "
                         "and eats with them.'")
    ...
    print(f"   {disciples_reaction}")
    print()
    print("🙏 May we embrace God's grace and extend forgiveness to others, just as the father   
            in the parable did!")
