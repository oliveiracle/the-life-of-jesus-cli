...
if option == "1":
    ...
    purpose_formated = purpose.capitalize()  # "Analyze Soil and Rock Samples"
    builder = "NASA's Jet Propulsion Laboratory"
    launch_year = 2011
    landing_year = 2012
    ...
    print(f"🔴 {mission_type}: {mission_name}")
    print(f"📍 Destination: {planet}")
    print(f"🎯 Mission: To {purpose_formated} to understand Mars' geology")
    print(f"🚀 Launched: {launch_year} | 🛬 Landed: {landing_year}")
    print(f"💰 Mission Cost: ${cost:,} USD")
    print(f"🏭 Built by: {builder}")
    print(f"📌 Current Location: {location}")
    ...
    purpose_formated = purpose.capitalize()  # "Study Saturn and Its Moons"
    ...
    print(f"🪐 {mission_type}: {mission_name}")
    print(f"📍 Destination: {planet}")
    print(f"🎯 Primary Mission: To {purpose_formated} and analyze Saturn's rings")
    ...
    purpose_formated = purpose.capitalize()  # "Conduct a Flyby of Pluto and Study Kuiper Belt Objects"
    ...
    print(f"🚀 {mission_type}: {mission_name}")
    print(f"📍 Destination: {planet}")
    print(f"🎯 Primary Mission: To {purpose_formated}")
    ...
    purpose_formated = purpose.capitalize()  # "Study Jupiter and Its Moons"
    builder = "NASA's Jet Propulsion Laboratory"
    launch_year = 1989
    arrival_year = 1995
    end_year = 2003
    ...
    specialty_formated = specialty.capitalize()  # "Exoplanet Discovery"
    partners = "NASA and JPL"
    launch_year = 2009
    end_year = 2018
    ...
    current_situation_formated = current_situation.capitalize()
    ...
    print(f"💰 Total Cost: ${cost:,} USD")
    print(f"🤝 Built by: {partners}")
    print(f"📡 Current Status: {current_situation_formated}")
    ...
    purpose_formated = purpose.capitalize()  # "Collect Samples from the Asteroid and Return Them to Earth"
    builder = "Lockheed Martin"
    launch_year = 2016
    arrival_year = 2018
    return_year = 2023
    ...
    print(f"🎯 Primary Mission:  {purpose_formated} for analysis")
    print(f"🚀 Launched: {launch_year} | Arrived: {arrival_year}")
