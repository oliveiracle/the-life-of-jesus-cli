...
# Convert option to integer for moment selection
option = int(input("Enter your choice (1-25) or 'quit' to exit: ").strip())
...
# MOMENT 5 - THE TEMPTATION
    ...
    verse_text = "Man shall not live on bread alone, but on every word that comes from the mouth of God."
    significance = "proved Jesus' sinlessness and authority over Satan"
    duration = "40 days and 40 nights"
    temptations = "Turn stones to bread, Jump from temple, Worship Satan for kingdoms"
    ...
    print(f"🎯 SIGNIFICANCE:")
    print(f"   This moment {significance}.")
    print(f"   Where Adam failed, Jesus succeeded!")
    print()
    print(f"😈 THE THREE TEMPTATIONS:")
    print(f"   {temptations}")
    print()
    print(f"⚔️ JESUS' WEAPON:")
...
# MOMENT 13 - HEALING THE BLIND MAN
elif option == "13":
    moment_name = "Healing the Blind Man"
    moment_type = "Miracle of Sight"
    location = "Jerusalem, Pool of Siloam"
    participants = "Jesus, blind man, Pharisees, disciples"
    main_verse = "John 9:25"
    verse_text = "One thing I do know. I was blind but now I see!"
    significance = "revealed Jesus as the Light of the World"
    question_disciples = "Rabbi, who sinned, this man or his parents, that he was born blind?"
    jesus_answer = "Neither this man nor his parents sinned, but this happened so that the works of God might be displayed in him"
    how_healed = "Jesus made mud with saliva, put it on man's eyes, told him to wash in Pool of Siloam"
    pharisees_reaction = "Some said 'He is not from God, for he does not keep the Sabbath.' Others asked 'How can a sinner perform such signs?'"
    man_testimony = "Whether he is a sinner or not, I don't know. One thing I do know: I was blind but now I see!"
    
    print("=" * 70)
    print(f"👁️ {moment_type}: {jesus_moments.moment13_formatted}")
    print("=" * 70)
    print(f"📍 Location: {location}")
    print(f"👥 Key People: {participants}")
    print()
    ...
    print(f"🎯 SIGNIFICANCE:")
    print(f"   This moment {significance}.")
    print(f"   Jesus healed a man born blind - impossible by human means!")
    print()
    print(f"❓ THE DISCIPLES' QUESTION:")
    print(f"   \"{question_disciples}\" - John 9:2")
    print()
    print(f"💡 JESUS' PROFOUND ANSWER:")
    print(f"   \"{jesus_answer}\" - John 9:3")
    print(f"   Not all suffering is punishment - sometimes it's for God's glory!")
    print()
    print(f"🙌 HOW THE HEALING HAPPENED:")
    print(f"   {how_healed}.")
    print(f"   The man obeyed and was healed!")
    print()
    print(f"😤 PHARISEES' DIVISION:")
    print(f"   {pharisees_reaction}")
    print()
    print(f"🔥 THE MAN'S POWERFUL TESTIMONY:")
    print(f"   \"{man_testimony}\" - John 9:25")
    print(f"   Simple but undeniable truth!")
    print()
    print(f"✨ John 9:5 - Jesus declared:")
    print(f"   'While I am in the world, I am the light of the world.'")
    print() 
    print("🙏 Jesus gives sight to the physically and spiritually blind!")
    
    # MOMENT 14 - THE SERMON ON THE MOUNT
elif option == "14":
    moment_name = "The Sermon on the Mount"
    moment_type = "Greatest Teaching"
    location = "Mountain near Capernaum"
    participants = "Jesus, disciples, large crowds"
    main_verse = "Matthew 5:3"
    verse_text = "Blessed are the poor in spirit, for theirs is the kingdom of heaven."
    significance = "contains Jesus' most famous teachings on kingdom living"
    chapters = "Matthew 5-7 (3 full chapters)"
    key_teachings = "Beatitudes, Lord's Prayer, Golden Rule, Salt and Light"
    beatitudes_start = "Blessed are the poor in spirit, the mourning, the meek, those who hunger for righteousness"
    lords_prayer = "Our Father in heaven, hallowed be your name, your kingdom come, your will be done"
    golden_rule = "Do to others what you would have them do to you"
    salt_and_light = "You are the salt of the earth... You are the light of the world"
    
    print("=" * 70)
    print(f"⛰️ {moment_type}: {jesus_moments.moment14_formatted}")
    print("=" * 70)
    print(f"📍 Location: {location}")
    print(f"👥 Key People: {participants}")
    print(f"📚 Scripture: {chapters}")
    print()
    print(f"📖 KEY VERSE: {main_verse}")
    print(f"💬 \"{verse_text}\"")
    print()
    print(f"🎯 SIGNIFICANCE:")
    print(f"   This moment {significance}.")
    print(f"   The foundation of Christian ethics and discipleship!")
    print()
    print(f"✨ KEY TEACHINGS INCLUDED:")
    print(f"   • {key_teachings}")
    print()
    print(f"🙏 THE BEATITUDES (Blessings):")
    print(f"   {beatitudes_start}...")
    print(f"   Nine blessings showing God's upside-down kingdom!")
    print()
    print(f"📿 THE LORD'S PRAYER:")
    print(f"   \"{lords_prayer}...\" - Matthew 6:9-13")
    print(f"   Jesus teaches us HOW to pray!")
    print()
    print(f"💛 THE GOLDEN RULE:")
    print(f"   \"{golden_rule}\" - Matthew 7:12")
    print(f"   The summary of how to treat others!")
    print()
    print(f"🧂💡 SALT AND LIGHT:")
    print(f"   \"{salt_and_light}\" - Matthew 5:13-14")
    print(f"   Christians are called to influence and illuminate the world!")
    print()
    print(f"⚠️ JESUS' AUTHORITY:")
    print(f"   'The crowds were amazed at his teaching, because he taught")
    print(f"   as one who had authority' - Matthew 7:28-29")
    print()
    print("🙏 The greatest sermon ever preached - life-changing truths!")
    
# MOMENT 15 - THE PARABLE OF THE PRODIGAL SON
elif option == "15":
    moment_name = "The Parable of the Prodigal Son"
    moment_type = "Parable of God's Love"
    location = "Teaching to Pharisees and tax collectors"
    participants = "Jesus (storyteller), father, prodigal son, older brother"
    main_verse = "Luke 15:24"
    verse_text = "For this son of mine was dead and is alive again; he was lost and is found."
    significance = "reveals God's heart of forgiveness and unconditional love"
    scripture = "Luke 15:11-32"
    younger_son_request = "Father, give me my share of the estate"
    son_actions = "Squandered wealth in wild living, ended up feeding pigs, starving"
    son_repentance = "I will go back to my father and say: Father, I have sinned against heaven and you"
    father_response = "Saw him from far away, filled with compassion, ran to him, kissed him"
    celebration = "Brought the best robe, ring, sandals, killed fattened calf"
    older_brother = "Angry, refused to join celebration, complained about never receiving a feast"
    father_to_older = "My son, you are always with me, and everything I have is yours"
    
    print("=" * 70)
    print(f"🏠 {moment_type}: {jesus_moments.moment15_formatted}")
    print("=" * 70)
    print(f"📍 Context: {location}")
    print(f"👥 Characters: {participants}")
    ...
    print()
    print(f"🎯 SIGNIFICANCE:")
    print(f"   This parable {significance}.")
    print(f"   Perhaps the most beautiful story Jesus ever told!")
    print()
    print(f"💰 THE SON'S REBELLION:")
    print(f"   \"{younger_son_request}\" - Luke 15:12")
    print(f"   Then he {son_actions}.")
    print()
    print(f"😢 HITTING ROCK BOTTOM:")
    print(f"   'He longed to fill his stomach with the pods the pigs ate' - Luke 15:16")
    print(f"   He finally came to his senses!")
    print()
    print(f"🙏 THE SON'S REPENTANCE:")
    print(f"   \"{son_repentance}\" - Luke 15:18")
    print()
    print(f"❤️ THE FATHER'S AMAZING RESPONSE:")
    print(f"   {father_response}!")
    print(f"   He didn't wait - he RAN to embrace his son!")
    print()
    print(f"🎉 THE CELEBRATION:")
    print(f"   {celebration}.")
    print(f"   'Let's have a feast and celebrate!' - Luke 15:23")
    print()
    print(f"😤 THE OLDER BROTHER'S REACTION:")
    print(f"   {older_brother}.")
    print()
    print(f"💡 THE FATHER'S WISDOM:")
    print(f"   \"{father_to_older}.")
    print(f"   But we had to celebrate because your brother was dead and is alive!\"")
    print()
    print(f"✨ THREE CHARACTERS, THREE LESSONS:")
    print(f"   • Younger son = Repentant sinners welcomed by God")
    print(f"   • Father = God's extravagant, unconditional love")
    print(f"   • Older brother = Religious people who resent God's grace")
    print()
    print("🙏 No matter how far you've fallen, the Father is waiting to run to you!")